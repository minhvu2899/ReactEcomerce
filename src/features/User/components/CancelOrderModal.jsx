...
import { Avatar, Button, Container, Dialog, DialogContent, DialogTitle, IconButton, LinearProgress, makeStyles, Typography } from '@mui/material';
...
function CancelOrderModal({ open, handleChange, onSubmit }) {
    ...
    return (
        ...
        < >
            <Dialog disableBackdropClick disableEscapeKeyDown disableEnforceFocus open={open} aria-labelledby="form-dialog-title" maxWidth="sm" fullWidth="true">
                ...
                <DialogTitle>Hủy đơn hàng</DialogTitle>
                <DialogContent>
                        ...
                        <Controller
                            ...
                            render={(
                                ...
                                <FormControl fullWidth>
                                    <InputLabel id="status-select-label">Lí do hủy</InputLabel>
                                    <Select
